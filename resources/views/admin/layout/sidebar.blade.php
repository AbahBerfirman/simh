<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/user/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_user_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="user"><i class="fa fa-users"></i> <span>User</span></a></li>

            <li class="nav-item dropdown {{ Request::is('admin/data/*') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-superpowers"></i><span>Data Section</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/data/kota/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_kota_view') }}"><i class="fa fa-angle-right"></i> Kota</a></li>

                    <li class="{{ Request::is('admin/data/apartement/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_apartement_view') }}"><i class="fa fa-angle-right"></i> Apartement</a></li>

                    <li class="{{ Request::is('admin/data/alamat/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_alamat_view') }}"><i class="fa fa-angle-right"></i> Alamat</a></li>

                    <li class="{{ Request::is('admin/data/kamar/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_kamar_view') }}"><i class="fa fa-angle-right"></i> Kamar</a></li>

                    <li class="{{ Request::is('admin/data/duration/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_duration_view') }}"><i class="fa fa-angle-right"></i> Duration</a></li>

                    <li class="{{ Request::is('admin/data/harga/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_harga_view') }}"><i class="fa fa-angle-right"></i> Harga</a></li>

                    <li class="{{ Request::is('admin/data/broker/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_broker_view') }}"><i class="fa fa-angle-right"></i> Broker</a></li>

                    <li class="{{ Request::is('admin/data/pelanggan/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_pelanggan_view') }}"><i class="fa fa-angle-right"></i> Customer</a></li>

                    {{-- <li class="{{ Request::is('admin/pelanggan/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_pelanggan_view') }}"><i class="fa fa-angle-right"></i> Customer</a></li> --}}
                </ul>
            </li>
