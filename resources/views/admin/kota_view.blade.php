...
@section('heading', 'View Cities')

@section('right_top_button')
<a href="{{ route('admin_kota_add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        ...
                                        {{-- <a href="{{ route('admin_kota_gallery',$row->id) }}" class="btn btn-success">Gallery</a> --}}

                                        <a href="{{ route('admin_kota_edit',$row->id) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('admin_kota_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
