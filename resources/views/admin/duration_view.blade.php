...
@section('heading', 'View Duration')

@section('right_top_button')
<a href="{{ route('admin_duration_add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        ...
                                        {{-- <a href="{{ route('admin_duration_gallery',$row->id) }}" class="btn btn-success">Gallery</a> --}}

                                        <a href="{{ route('admin_duration_edit',$row->id) }}" class="btn btn-primary">Edit</a>
                                        <a href="{{ route('admin_duration_delete',$row->id) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
