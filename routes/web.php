...
use App\Http\Controllers\Admin\AdminAlamatController;
...
use App\Http\Controllers\Admin\AdminApartementController;
...
Route::group(['middleware' =>['admin:admin']], function(){
    ...
    Route::get('/admin/user/view', [AdminUserController::class, 'index'])->name('admin_user_view')->middleware(['auth', 'isadmin']);
    Route::get('/admin/user/add', [AdminUserController::class, 'add'])->name('admin_user_add')->middleware(['auth', 'isadmin']);
    Route::post('/admin/user/store', [AdminUserController::class, 'store'])->name('admin_user_store')->middleware(['auth', 'isadmin']);
    Route::get('/admin/user/edit/{id}', [AdminUserController::class, 'edit'])->name('admin_user_edit')->middleware(['auth', 'isadmin']);
    Route::post('/admin/user/update/{id}', [AdminUserController::class, 'update'])->name('admin_user_update')->middleware(['auth', 'isadmin']);
    Route::get('/admin/user/delete/{id}', [AdminUserController::class, 'delete'])->name('admin_user_delete')->middleware(['auth', 'isadmin']);
